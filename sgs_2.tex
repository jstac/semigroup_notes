...
If $\pP(x,X)=1$ for all $x\in X$, $\PP$ is a \emph{transition probability.} 
 ...
 \end{proposition}
\begin{proof}
Intuition seems straightfoward but the proof....takes time to understand....

Since $(X_1,\Sigma_1)$ is a Boral space, there exist measureble bijection $\phi\colon X_1\rightarrow[0,1] .$ We need to define $\kappa$ $\st$ for all $x\in X_0,$
\begin{equation*}
\Prob(\kappa(x,v)\in B)=\pP(x,B)
\end{equation*}
